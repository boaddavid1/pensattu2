...
('Worship & Music', 'Musicians, singers and sound volunteers shaping every Sunday''s atmosphere.', 'music', '/images/pensafallback-bw.png', 1, TRUE),
('Outreach & Missions', 'Serving neighborhoods across Accra with food, care, and practical help.', 'heart', '/images/pensafallback-bw.png', 2, TRUE),
('Counseling & Care', 'One-on-one time with our pastoral team, in confidence, whenever it''s needed.', 'users', '/images/pensafallback-bw.png', 3, TRUE),
('Bible Study Groups', 'Weekday gatherings that go deeper into scripture, together.', 'book', '/images/pensafallback-bw.png', 4, TRUE);

-- Sermons / messages
INSERT INTO sermons (title, speaker, category, description, audio_url, image_url, date_preached, is_active) VALUES
('What it means to belong before you believe', 'Pastor Mark Johnson', 'Sermon', 'A look at belonging as the doorway to belief.', NULL, '/images/pensafallback-bw.png', '2026-08-09', TRUE),
('Why we built community groups around neighborhoods', 'Pastor Helen Owusu', 'Community', 'How neighborhood groups make community accessible.', NULL, '/images/pensafallback-bw.png', '2026-08-06', TRUE),
('Inside our latest outreach across Accra', 'Pastor Alex Mensah', 'Outreach', 'A recap of our recent city-wide outreach.', NULL, '/images/pensafallback-bw.png', '2026-08-02', TRUE);
...
('Pastor Mark Johnson', 'Senior Pastor', 'Executive', '2025/2026', 'Theology', 'Off-Campus', NULL, 'Lead pastor overseeing the ministry.', '/images/pensafallback-bw.png', 1, TRUE),
('Pastor Helen Owusu', 'Worship Pastor', 'Executive', '2025/2026', 'Music', 'Off-Campus', NULL, 'Leads worship and the music ministry.', '/images/pensafallback-bw.png', 2, TRUE),
('Pastor Alex Mensah', 'Youth Pastor', 'Executive', '2025/2026', 'Youth Ministry', 'Off-Campus', NULL, 'Shepherds the youth and campus outreach.', '/images/pensafallback-bw.png', 3, TRUE),
('Elder Kwame Asante', 'Executive Pastor', 'Executive', '2025/2026', 'Administration', 'Off-Campus', NULL, 'Oversees operations and administration.', '/images/pensafallback-bw.png', 4, TRUE);
...
('Sunday Worship', 'Moments from our Sunday services.', '/images/pensafallback-bw.png'),
('Community Life', 'Small groups and gatherings.', '/images/pensafallback-bw.png'),
('Outreach', 'Serving our city.', '/images/pensafallback-bw.png'),
('Youth & Kids', 'The next generation.', '/images/pensafallback-bw.png');
...
(1, 'Hands raised in worship', 'Worship', 'Sunday morning, 11AM', '/images/pensafallback-bw.png'),
(1, 'Sanctuary interior', 'Worship', 'Our sanctuary', '/images/pensafallback-bw.png'),
(1, 'Worship band', 'Worship', 'Music ministry', '/images/pensafallback-bw.png'),
(1, 'Sunday service', 'Worship', 'A packed 9AM service', '/images/pensafallback-bw.png'),
(2, 'Community group meeting', 'Community', 'East Legon group night', '/images/pensafallback-bw.png'),
(2, 'Bible study group', 'Community', 'Midweek Bible study', '/images/pensafallback-bw.png'),
(2, 'Greeters welcoming visitors', 'Community', 'First-Sunday greeters', '/images/pensafallback-bw.png'),
(3, 'Outreach event', 'Outreach', 'Serving Osu this spring', '/images/pensafallback-bw.png'),
(3, 'Planning an outreach event', 'Outreach', 'Getting ready to serve', '/images/pensafallback-bw.png'),
(4, 'Youth ministry gathering', 'Youth', 'Friday youth night', '/images/pensafallback-bw.png'),
(4, 'Youth small group', 'Youth', 'Youth small group', '/images/pensafallback-bw.png');
